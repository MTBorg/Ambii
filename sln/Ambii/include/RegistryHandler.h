...
private:
	...
	static CONST struct m_valueNames {
		...
		static CONST LPCWSTR CLOCKWISE_LEFT;
		static CONST LPCWSTR CLOCKWISE_RIGHT;
		static CONST LPCWSTR CLOCKWISE_TOP;
		static CONST LPCWSTR CLOCKWISE_BOTTOM;
		static CONST LPCWSTR ENABLE_LEFT;
		static CONST LPCWSTR ENABLE_RIGHT;
		static CONST LPCWSTR ENABLE_TOP;
		static CONST LPCWSTR ENABLE_BOTTOM;
	};
